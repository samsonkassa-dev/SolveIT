...
export class ApiService {
  ...
  public get(path: string): Observable<any> {
    ...
    return this.http
      .get(`${this.ROOT_PATH}${path}`, { headers: this.headers })
  ...
  public post(path: string, body): Observable<any> {
    this.setHeaders(this.TOKEN_KEY);
    return this.http
      .post(`${this.ROOT_PATH}${path}`, body, { headers: this.headers })
      .map((res: Response) => res.json());
  }
  ...
  public put(path: string, body): Observable<any> {
    this.setHeaders(this.TOKEN_KEY);
    return this.http
      .put(`${this.ROOT_PATH}${path}`, body, { headers: this.headers })
      .map((res: Response) => res.json());
  }
  ...
  public delete(path: string): Observable<any> {
    this.setHeaders(this.TOKEN_KEY);
    return this.http
      .delete(`${this.ROOT_PATH}${path}`, { headers: this.headers })
      .map((res: Response) => res.json());
  }
  ...
  public patch(path: string, body: any): Observable<any> {
    this.setHeaders(this.TOKEN_KEY);
    return this.http
      .patch(`${this.ROOT_PATH}${path}`, body, { headers: this.headers })
      .map((res: Response) => res.json());
  }
